        ...
        <div className="mb-8 rounded-3xl border border-off/10 bg-black/35 p-5 backdrop-blur-md sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <label className="w-full lg:max-w-[260px]">
              ...
              >
                <option className="bg-white text-black" value="relevancia">
                  Relevância
                </option>
                <option className="bg-white text-black" value="mais-recentes">
                  Mais recentes
                </option>
                <option className="bg-white text-black" value="preco-menor">
                  Menor preço
                </option>
                <option className="bg-white text-black" value="preco-maior">
                  Maior preço
                </option>
                <option className="bg-white text-black" value="nome-az">
                  Nome (A-Z)
                </option>
                <option className="bg-white text-black" value="nome-za">
                  Nome (Z-A)
                </option>
              </select>
            </label>
